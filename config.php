<?php
// HTTP
define('HTTP_SERVER', 'http://localhost/capstone/');

// HTTPS
define('HTTPS_SERVER', 'http://localhost/capstone/');

// DIR
define('DIR_APPLICATION', '/Applications/XAMPP/xamppfiles/htdocs/capstone/catalog/');
...
define('DIR_LANGUAGE', '/Applications/XAMPP/xamppfiles/htdocs/capstone/catalog/language/');
define('DIR_TEMPLATE', '/Applications/XAMPP/xamppfiles/htdocs/capstone/catalog/view/theme/');
