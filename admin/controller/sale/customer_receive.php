...
class ControllerSaleCustomerReceive extends Controller { 
  ...
  ////////////////////////////////////////////////////////////// 
    ...
    function searchStudentByFileCode(){
        $json = array();

        $this->load->model('sale/customer');
        $json['student']  = $this->model_sale_customer->getStudentIDFromBarcode($this->request->post['file_code']);
    ...
    function confirmStudent(){
        ...
        $this->load->model('sale/customer');
        $this->model_sale_customer->confirmStudent((int)$this->request->post['student_id'], 1);
