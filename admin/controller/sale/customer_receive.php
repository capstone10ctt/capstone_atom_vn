...
class ControllerSaleCustomerReceive extends Controller { 
  ...
  ////////////////////////////////////////////////////////////// 
  	...
  	protected function getList() {
		...
		$this->data['report'] = $this->url->link('sale/customer_receive/report_online', 'token=' . $this->session->data['token'] . $url, 'SSL');
  ...
  ////////////////////////////////////////////////////////////// 
	...
	public function report_online() {
			...
			$this->document->setTitle($this->language->get('text_report_online'));
			...
			$this->data['text_online_app'] = $this->language->get('text_online_app');
			$this->data['text_paper_app'] = $this->language->get('text_paper_app');
			$this->data['text_no_paper_app'] = $this->language->get('text_no_paper_app');
			$this->data['text_area_app'] = $this->language->get('text_area_app');
			$this->data['text_online'] = $this->language->get('text_online');
			$this->data['text_new_student'] = $this->language->get('text_new_student');
			$this->data['text_stay_student'] = $this->language->get('text_stay_student');
		...
		$this->data['insert'] = $this->url->link('sale/customer/insert', 'token=' . $this->session->data['token'] . $url, 'SSL');
		$this->data['delete'] = $this->url->link('sale/customer/delete', 'token=' . $this->session->data['token'] . $url, 'SSL');
		$this->data['report_online'] = $this->url->link('sale/customer_receive/report_online', 'token=' . $this->session->data['token'] . $url, 'SSL');

		$this->data['report_paper'] = $this->url->link('sale/customer_receive/report_paper', 'token=' . $this->session->data['token'] . $url, 'SSL');
		$this->data['report_no_paper'] = $this->url->link('sale/customer_receive/report_no_paper', 'token=' . $this->session->data['token'] . $url, 'SSL');
		$this->data['report_area'] = $this->url->link('sale/customer_receive/report_area', 'token=' . $this->session->data['token'] . $url, 'SSL');
		...
		$this->template = 'sale/customer_list_receive_report_online.tpl';
		$this->children = array(
			'common/header',
			'common/footer'
		);
	...
	public function report_paper() {

			$this->language->load('sale/customer_receive');
		 
			$this->document->setTitle($this->language->get('text_report_paper'));
			...
			$this->data['text_resident'] = $this->language->get('text_resident');
			$this->data['text_not_resident'] = $this->language->get('text_not_resident');
			$this->data['text_paper'] = $this->language->get('text_paper');
		...
		$this->template = 'sale/customer_list_receive_report_paper.tpl';
		$this->children = array(
			'common/header',
			'common/footer'
		);
	...
	public function report_no_paper() {

			$this->language->load('sale/customer_receive');
		 
			$this->document->setTitle($this->language->get('text_report_no_paper'));
			...
			$this->data['text_resident'] = $this->language->get('text_resident');
			$this->data['text_not_resident'] = $this->language->get('text_not_resident');
			$this->data['text_no_paper'] = $this->language->get('text_no_paper');
		...
		$this->template = 'sale/customer_list_receive_report_no_paper.tpl';
		$this->children = array(
			'common/header',
			'common/footer'
		);
	...
	public function report_area() {
		...
		$this->template = 'sale/customer_list_receive_report_area.tpl';
		$this->children = array(
			'common/header',
			'common/footer'
		);
