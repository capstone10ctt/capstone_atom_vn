...
class ControllerSaleCustomerApproval extends Controller { 
  ...
  ////////////////////////////////////////////////////////////// 
  	...
  	protected function getList() {
		...
		$this->data['approve'] = $this->url->link('sale/customer_approval/approve', 'token=' . $this->session->data['token'] . $url, 'SSL');
		$this->data['unapprove'] = $this->url->link('sale/customer_approval/unapprove', 'token=' . $this->session->data['token'] . $url, 'SSL');
    	...
    	foreach ($results as $result) {
			...
			$this->data['customers'][] = array(
				...
				'approved'       => ($result['approved'] ? $this->language->get('text_approve') : $this->language->get('text_not_approve')),
		...
		$this->data['sort_approved'] = $this->url->link('sale/customer_approval', 'token=' . $this->session->data['token'] . '&sort=c.approved' . $url, 'SSL');
