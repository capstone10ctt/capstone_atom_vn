...
class ControllerSaleCustomerApproval extends Controller { 
  ...
  ////////////////////////////////////////////////////////////// 
	...
	public function student_information() {
			...
			$this->data['entry_male'] = $this->language->get('entry_male');
			$this->data['entry_female'] = $this->language->get('entry_female');
		...
		if (isset($this->request->get['student_id'])) {
  		...
  		$this->data['breadcrumbs'] = array();
   		...
   		$this->data['breadcrumbs'][] = array(
       		'text'      => $this->language->get('text_student_information'),
			'href'      => $this->url->link('sale/customer_approval/student_information', 'token=' . $this->session->data['token'] . $url, 'SSL'),
      		'separator' => ' :: '
   		);
		
		$this->data['verify'] = $this->url->link('sale/customer_approval/verify', 'token=' . $this->session->data['token'] . $url, 'SSL');
		$this->data['unverify'] = $this->url->link('sale/customer_approval/unverify', 'token=' . $this->session->data['token'] . $url, 'SSL');

		$this->data['student'] = $this->model_sale_customer->getCustomer($student_id);
	
					
		$this->data['heading_title'] = $this->language->get('text_student_information');
		...
		$this->data['text_unverify'] = $this->language->get('text_unverify');
		...
		$this->data['text_verified'] = $this->language->get('text_verified');
		$this->data['text_notverifiedyet'] = $this->language->get('text_notverifiedyet');
		...
		$this->template = 'sale/customer_list_approval_student_information.tpl';
		$this->children = array(
			'common/header',
			'common/footer'
		);
  	...
  	protected function getList() {
		...
		$this->data['verify'] = $this->url->link('sale/customer_approval/verify', 'token=' . $this->session->data['token'] . $url, 'SSL');
		$this->data['report'] = $this->url->link('sale/customer_approval/report_valid', 'token=' . $this->session->data['token'] . $url, 'SSL');
    	...
    	foreach ($results as $result) {
			...
			$action[] = array(
				...
				'href' => $this->url->link('sale/customer_approval/student_information', 'token=' . $this->session->data['token'] . '&student_id=' . $result['customer_id'] . $url, 'SSL')
			);
  	...
  	public function report_valid() {
            $this->language->load('sale/customer_approval');
		 
			$this->document->setTitle($this->language->get('text_report_valid'));
			...
			$this->data['text_select_field'] = $this->language->get('text_select_field');
			$this->data['text_unidentified_field'] = $this->language->get('text_unidentified_field');
			$this->data['text_report_valid'] = $this->language->get('text_report_valid');
			$this->data['text_report_field'] = $this->language->get('text_report_field');
			$this->data['text_report'] = $this->language->get('text_report');
			$this->data['text_valid_app'] = $this->language->get('text_valid_app');
			...
			$this->data['text_new_invalid'] = $this->language->get('text_new_invalid');
			$this->data['text_resident_valid'] = $this->language->get('text_resident_valid');
			$this->data['text_resident_invalid'] = $this->language->get('text_resident_invalid');
		...
		if (isset($this->request->get['page'])) {
  		...
  		$this->data['breadcrumbs'] = array();
   		...
   		$this->data['breadcrumbs'][] = array(
       		'text'      => $this->language->get('text_report_valid'),
			'href'      => $this->url->link('sale/customer_approval/report_valid', 'token=' . $this->session->data['token'] . $url, 'SSL'),
      		'separator' => ' :: '
   		);
		

		$this->data['report_valid'] = $this->url->link('sale/customer_approval/report_valid', 'token=' . $this->session->data['token'] . $url, 'SSL');
		$this->data['report_field'] = $this->url->link('sale/customer_approval/report_field', 'token=' . $this->session->data['token'] . $url, 'SSL');
		$this->data['insert'] = $this->url->link('sale/customer/insert', 'token=' . $this->session->data['token'] . $url, 'SSL');
		$this->data['delete'] = $this->url->link('sale/customer/delete', 'token=' . $this->session->data['token'] . $url, 'SSL');
		...
		$this->data['heading_title'] = $this->language->get('text_report_valid');
		...
		$pagination->limit = $this->config->get('config_admin_limit');
		$pagination->text = $this->language->get('text_pagination');
		$pagination->url = $this->url->link('sale/customer_approval/report_valid', 'token=' . $this->session->data['token'] . $url . '&page={page}', 'SSL');
		...
		$this->template = 'sale/customer_list_approval_report_valid.tpl';
		$this->children = array(
			'common/header',
			'common/footer'
		);
  	...
  	public function report_field() {
			...
			$this->document->setTitle($this->language->get('text_report_field'));
		...
		if (isset($this->request->get['page'])) {
  		...
  		$this->data['breadcrumbs'] = array();
   		...
   		$this->data['breadcrumbs'][] = array(
       		'text'      => $this->language->get('text_report_field'),
			'href'      => $this->url->link('sale/customer_approval/report_field', 'token=' . $this->session->data['token'] . $url, 'SSL'),
      		'separator' => ' :: '
   		);
		...
		$this->template = 'sale/customer_list_approval_report_field.tpl';
		$this->children = array(
			'common/header',
			'common/footer'
		);
