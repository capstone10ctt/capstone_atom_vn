...
<div id="content">
  ...
  <div class="box">
    ...
    <h2><?php echo $text_report; ?></h2>
      <?php echo $text_valid_app; ?><br />
      <a href="<?php echo $report_field; ?>"><?php echo $text_field_app; ?></a><br />
    </div>
    <div id="rightcol" style="margin-left:300px;text-alignment:left">
        <table class="list">
          ...
          <tbody>
            <tr>
                <td class="left"><?php echo $text_total_verify; ?></td>
                <?php $total=0;
                foreach ($genders as $gender) {
            ...
            <tr>
                <td class="left"><?php echo $text_new_valid; ?></td>
                <?php $total=0;
                foreach ($genders as $gender) {
            ...
            <tr>
                <td class="left"><?php echo $text_resident_valid; ?></td>
                <?php $total=0;
                foreach ($genders as $gender) {
            ...
            <tr>
                <td class="left"><?php echo $text_new_invalid; ?></td>
                <?php $total=0;
                foreach ($genders as $gender) {
                  echo '<td class="left">'.$count_new_invalid[$gender['gender_id']].'</td>';
                  $total+=$count_new_invalid[$gender['gender_id']];
                }?>
                <td class="left"><?php echo $total; ?></td>
            </tr>
            <tr>
                <td class="left"><?php echo $text_resident_invalid; ?></td>
                <?php $total=0;
                foreach ($genders as $gender) {
                  echo '<td class="left">'.$count_resident_invalid[$gender['gender_id']].'</td>';
                  $total+=$count_resident_invalid[$gender['gender_id']];
                }?>
                <td class="left"><?php echo $total; ?></td>
            </tr>
          </tbody>
...
$('select[name=\'filter_period\']').on('change', function (e) {
    ...
    url = 'index.php?route=sale/customer_approval/report_valid&token=<?php echo $token; ?>';
    if(valueSelected)
    {
