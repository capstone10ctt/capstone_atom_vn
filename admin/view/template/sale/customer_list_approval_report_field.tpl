...
<div id="content">
  ...
  <div class="box">
    ...
    <h2><?php echo $text_report; ?></h2>
      <a href="<?php echo $report_valid; ?>"><?php echo $text_valid_app; ?></a><br />
      <?php echo $text_field_app; ?><br />
    </div>
...
$(document).ready(function() {
  ...
  $('select[name=\'filter_period\']').on('change', function (e) {
    ...
    url = 'index.php?route=sale/customer_approval/report_field&token=<?php echo $token; ?>';
    if(valueSelected)
    {
