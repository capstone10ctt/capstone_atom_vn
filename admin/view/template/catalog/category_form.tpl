          ...
          <div id="language<?php echo $language['language_id']; ?>">
            <table class="form">
              <tr>
                ...
                <tr>
                    <td><span class="required">*</span><?php echo $entry_male_qty; ?></td>
                    <td><input type="text" name="male_qty" value="<?php echo $male_qty; ?>" size="1" /></td>
                </tr>
                <tr>
                    <td><span class="required">*</span><?php echo $entry_female_qty; ?></td>
                    <td><input type="text" name="female_qty" value="<?php echo $female_qty; ?>" size="1" /></td>
                </tr>
            </table>
          </div>
          <?php } ?>
