    ...
    <div class="content">
      <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form">
		...
		<table id="custom" class="form">
			<tr><td><h3>Custom Slideshow Effect</h3></td></tr>
			<tr><td><input type="checkbox" value="random" name="Slide_Effect" <?php if (in_array('random', $Slide_Effect)) echo ' checked="checked"'; ?> /> random</td></tr>
			<tr><td><input type="checkbox" value="simpleFade" name="Slide_Effect" <?php if (in_array('simpleFade', $Slide_Effect)) echo ' checked="checked"'; ?> /> simpleFade</td></tr>
			<tr><td><input type="checkbox" value="curtain" name="Slide_Effect" <?php if (in_array('curtain', $Slide_Effect)) echo ' checked="checked"'; ?> /> curtain</td></tr>
			<tr><td><input type="checkbox" value="stampede" name="Slide_Effect" <?php if (in_array('stampede', $Slide_Effect)) echo ' checked="checked"'; ?> /> stampede</td></tr>
			<tr><td><input type="checkbox" value="mosaic" name="Slide_Effect" <?php if (in_array('mosaic', $Slide_Effect)) echo ' checked="checked"'; ?> /> mosaic</td></tr>
			<tr><td><input type="checkbox" value="scroll" name="Slide_Effect" <?php if (in_array('scroll', $Slide_Effect)) echo ' checked="checked"'; ?> /> scroll</td></tr>
			
			<tr><td><input type="hidden" value="" name="Slide_value_effect" id="effect" /></td></tr>
		</table>
...
$('input[name="Slide_Effect"]').change(function() {
	var value_effect = '';
