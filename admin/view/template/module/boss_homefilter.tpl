...
<div id="content">
        ...
        <table id="tab" class="list">
          <thead>
            <tr>
              ...
              <td class="left"><?php echo $tab_color; ?></td>
          ...
          <tbody id="tab-row<?php echo $tab_row; ?>">
            <tr>	 
			  ...
			  <td class="left">
				...
				<?php } ?></td>
			  <td class="left">				  
				  <select name="boss_homefilter_tab[<?php echo $tab_row; ?>][color]">
                  <?php if ($tab['color'] == 't_block_color_bg_1') { ?>
                  <option value="t_block_color_bg_1" selected="selected"><?php echo $tab_text_color_1; ?></option>
                  <?php } else { ?>
                  <option value="t_block_color_bg_1"><?php echo $tab_text_color_1; ?></option>
                  <?php } ?>
                  <?php if ($tab['color'] == 't_block_color_bg_2') { ?>
                  <option value="t_block_color_bg_2" selected="selected"><?php echo $tab_text_color_2; ?></option>
                  <?php } else { ?>
                  <option value="t_block_color_bg_2"><?php echo $tab_text_color_2; ?></option>
                  <?php } ?>
                  <?php if ($tab['color'] == 't_block_color_bg_3') { ?>
                  <option value="t_block_color_bg_3" selected="selected"><?php echo $tab_text_color_3; ?></option>
                  <?php } else { ?>
                  <option value="t_block_color_bg_3"><?php echo $tab_text_color_3; ?></option>
                  <?php } ?>
				  </select>
          ...
          <tbody id="module-row<?php echo $module_row; ?>">
            <tr>
			  ...
			  <td class="left"><select name="boss_homefilter_module[<?php echo $module_row; ?>][use_scrolling_panel]">
				...
				<input style="display:none;" type="text" name="boss_homefilter_module[<?php echo $module_row; ?>][scroll]" value="<?php echo $module['scroll']; ?>" size="3" />
				<?php if (isset($scroll[$module_row])) { ?>
                <span class="error"><?php echo $scroll[$module_row]; ?></span>
                <?php } ?></td>
			  <td class="left"><select name="boss_homefilter_module[<?php echo $module_row; ?>][use_tab]">
				<?php if ($module['use_tab']) { ?>
				<option value="1" selected="selected"><?php echo $text_enabled; ?></option>
				<option value="0"><?php echo $text_disabled; ?></option>
				<?php } else { ?>
				<option value="1"><?php echo $text_enabled; ?></option>
  ...
  <script type="text/javascript"><!--
    ...
    function addTab() {
	  ...
	  html += '</td>';
      html += '<td class="left">';
		html += '<input name="boss_homefilter_tab[' + tab_row + '][color]" />';
	  html += '</td>';
  ...
  <script type="text/javascript"><!--
    ...
    function addModule() {	
      ...
      html += '    </select>';
	  html += '	  <input  style="display:none;"  type="text" name="boss_homefilter_module[' + module_row + '][scroll]" value="6" size="3" />';
	  html += '	   </td>';
	  html += '	   <td class="left"><select name="boss_homefilter_module['+ module_row + '][use_tab]">';
	  html += '	     <option value="1" selected="selected"><?php echo $text_enabled; ?></option>';
	  html += '	     <option value="0"><?php echo $text_disabled; ?></option>';
	  html += '	   </select></td>';
