<?php
//Heading
$_['heading_title']         = 'Mẫu email';
$_['heading_title_install'] = 'Cài đặt mẫu email';

//Text
$_['text_success']          = 'Thành công: thay đổi đã được lưu!';
$_['text_success_install']  = 'Thành công: Module đã được cài đặt!';
$_['text_delete_success']   = 'Thành công: Một vài email đã được xóa!';
...
//Column
$_['column_template_email'] = 'Tiêu đề';
...
//Button
$_['button_mail'] = 'Tạo mẫu email mới';

//Entry
$_['entry_cron']                    = 'Cron:';
$_['entry_template_name']           = 'Tiêu đề:';
$_['entry_template_description']    = 'Nội dung:';
$_['entry_template_status']         = 'Đánh dấu nếu không muốn sử dụng mẫu này:';
$_['entry_template_promo']          = 'Text promo: <span class="help">tối đa 200 kí tự</span>';
