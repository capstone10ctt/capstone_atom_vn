...
$_['text_config_shopstatus']        = 'Shop Status:<br /><span class="help">State the status of shop, whether it is enabled or not.</span>';
$_['text_config_shopowner']         = 'Shop Owner:<br /><span class="help">Input the shop owner account to this store.The shop owner will access to this store through this account.</span>';
$_['text_enabled']                 	= 'Enabled';
$_['text_disabled']                 = 'Disabled';
$_['text_password']                 = 'Password:';
$_['text_is_registering']           = 'Register your store';
$_['text_is_registering_info']      = 'Your information';
$_['error_exists']         			= 'Warning: Shop domain is already registered!';
$_['error_exists_username']         = 'Warning: Email is already registered!';
$_['button_submit']         		= 'Submit';
$_['text_success_register']         = 'Success: You have submitted your information! We will contact you as soon as possible.';
//---------------Võ Lý Minh Nhân – volyminhnhan@gmail.com - 0902 644 077 - Atom Company----------------//
...
// Entry
//---------------Võ Lý Minh Nhân – volyminhnhan@gmail.com - 0902 644 077 - Atom Company----------------//
$_['entry_url_customer']           = 'Store Subdomain:<br /><span class="help">Include the Subdomain to access your store (belong to ATOM). Example: <br /><br /> http://<strong id="subdomain" style="color:red;margin:0px;padding:0px">yourstore</strong>.vnibc.vn/<br />';
//old function
$_['entry_url']                    = 'Store URL:<br /><span class="help">Include the full URL to your store. Make sure to add \'/\' at the end. Example: http://www.yourdomain.com/path/<br /><br /></span>';
//---------------Võ Lý Minh Nhân – volyminhnhan@gmail.com - 0902 644 077 - Atom Company----------------//
...
//---------------Võ Lý Minh Nhân – volyminhnhan@gmail.com - 0902 644 077 - Atom Company----------------//
$_['error_shopowner']              = 'Warning: Please input the shop owner !';
