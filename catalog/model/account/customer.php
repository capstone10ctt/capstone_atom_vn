...
class ModelAccountCustomer extends Model {
	...
	public function addCustomer($data) {
		...
		if((int)$data['university_id'] == (int)$NKUniversity) {
      	...
      	$this->db->query("INSERT INTO " . DB_PREFIX . "address SET customer_id = '" . (int)$customer_id . "', firstname = '" . $this->db->escape($data['fullname'])/*$this->db->escape($data['firstname'])*/ /*. "', lastname = '" . $this->db->escape($data['lastname'])*/ . "', sonha1 = '" . $this->db->escape($data['address_0']) ."', duong1 = '" . $this->db->escape($data['address_1']) . "', phuongxa1 = '" . $this->db->escape($data['address_2']) . "', quanhuyen1 = '" . $this->db->escape($data['address_3']) . "', thanhpho1 = '" . $this->db->escape($data['address_4']) . "', sonha2 = '" . $this->db->escape($data['address_5']) ."', duong2 = '" . $this->db->escape($data['address_6']) . "', phuongxa2 = '" . $this->db->escape($data['address_7']) . "', quanhuyen2 = '" . $this->db->escape($data['address_8']) . "', thanhpho2 = '" . $this->db->escape($data['address_9']) ."', country_id = '" . (int)$data['country_id'] . /*"', zone_id = '" . (int)$data['zone_id'] .*/ "'");
